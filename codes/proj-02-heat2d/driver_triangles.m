...
x_coor = zeros(n_np, 1);  % global number
y_coor = x_coor;
...
for ex = 1 : n_el_x
  for ey = 1 : n_el_y
        ...
        IEN(ee+1, 1) = (ey-1) * n_np_x + ex;
        IEN(ee+1, 2) =  ey    * n_np_x + ex + 1;
        IEN(ee+1, 3) =  ey    * n_np_x + ex;         
  end
end
...
for ee = 1 : n_el
  ...
  for ll = 1 : n_int
    ...
    for aa = 1 : n_en
      ...
      [Na_xi, Na_eta] = Quad_tri_grad(aa, xi(ll), eta(ll));
    ...
    for aa = 1 : n_en
      ...
      for bb = 1 : n_en
        ...
        [Nb_xi, Nb_eta] = Quad_tri_grad(bb, xi(ll), eta(ll));
...
% HEAT.mat
save("HEAT_triangles", "disp", "n_el_x", "n_el_y");
